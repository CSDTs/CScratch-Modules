...
'text/xml');
let newBlockDOM_drawcircle = (new DOMParser).parseFromString(NEW_BLOCK_STRING_drawcircle,
'text/xml');
...
'text/xml');
let newBlockDOM_false = (new DOMParser).parseFromString(NEW_BLOCK_STRING_false,
'text/xml');
let newBlockDOM_true = (new DOMParser).parseFromString(NEW_BLOCK_STRING_true,
'text/xml');
//
