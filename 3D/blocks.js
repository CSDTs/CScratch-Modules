...
Object.assign(ScratchBlocks.Blocks, {
    ...
    'looks_turncameraaroundx': {
        ...
        init: function () {
            this.jsonInit({
                "message0": "turn camera %1 degrees around x-axis",
                "args0": [
                    {
                        "type": "input_value",
                        "name": "DEGREES"
    ...
    'looks_turncameraaroundy': {
        ...
        init: function () {
            this.jsonInit({
                "message0": "turn camera %1 degrees around y-axis",
                "args0": [
                    {
                        "type": "input_value",
                        "name": "DEGREES"
    ...
    'looks_turnxameraaroundz': {
        ...
        init: function () {
            this.jsonInit({
                "message0": "turn camera %1 degrees around z-axis",
                "args0": [
                    {
                        "type": "input_value",
                        "name": "DEGREES"
