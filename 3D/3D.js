...
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_add.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_subtract.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_multiply.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_divide.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_random.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_lt.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_equals.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_gt.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_and.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_or.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_not.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_join.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_letter_of.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_length.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_mod.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_round.children[0])
toolboxDOM.getElementsByName('Operators')[0].appendChild(newBlockDOM_mathop.children[0])
